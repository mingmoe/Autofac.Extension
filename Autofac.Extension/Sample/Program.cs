...
public class Program
{
    class TargetClass
    {
        ...
        public required IOptions<SimplyConfigu> Options { get; init; }
    ...
    static void HostTest()
    {
        ...
        builder.ConfigureContainer((_, containerBuilder) =>
        {
            ...
            containerBuilder.Configure<SimplyConfigu>(Options.DefaultName, (c) =>
            {
                c.DefaultName = true;
            });
            containerBuilder.Configure<SimplyConfigu>(null, (c) =>
            {
                c.All = true;
            });
            containerBuilder.Configure<SimplyConfigu>("b", (c) =>
            {
                c.B = false;
            });
